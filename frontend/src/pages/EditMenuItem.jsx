        ...
        <div className="max-w-4xl mx-auto px-6 py-4 flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400 font-medium">Edit Menu Item</p>
            </div>
          </div>
      ...
      <main className="max-w-4xl mx-auto px-6 py-8">
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8">
          ...
          <div className="mb-6 border-b border-gray-100 pb-4">
            <h2 className="text-lg font-bold text-gray-900">Update Item Details</h2>
            <p className="text-xs text-gray-400">Modify the menu item details below.</p>
          </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-start">
              ...
              {currentImage && (
                <div>
                  ...
                  <div className="p-2 border border-gray-200 rounded-xl bg-gray-50/50 w-fit">
                    <img
                      src={currentImage}
                      alt={formData.name}
              ...
              <div className="w-full">
                ...
                <div className="flex justify-center px-6 pt-5 pb-6 border-2 border-gray-200 border-dashed rounded-xl hover:border-red-400 transition-colors bg-gray-50/50">
