    ...
    return (
      <div className="min-h-screen bg-gray-50/50 flex items-center justify-center py-12 px-6">
        <div className="text-center bg-white p-8 rounded-2xl border border-gray-100 shadow-sm max-w-md w-full">
          ...
          <h2 className="text-xl font-bold text-gray-900 mb-1">Item Not Found</h2>
          <p className="text-sm text-gray-500 mb-6">The menu item you are looking for does not exist or has been removed.</p>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
          ...
          <div className="p-8 sm:p-10">
            ...
            <div className="mt-8 pt-6 border-t border-gray-100 flex items-center justify-between">
              ...
              <Link
                to="/"
                className="inline-flex items-center gap-2 bg-red-500 text-white font-semibold px-6 py-3 rounded-xl hover:bg-red-600 active:scale-95 transition-all shadow-sm hover:shadow-md hover:shadow-red-500/20"
              >
